...
<head>
	...
	<title>PUSDATIN AMGA - Signup</title>
	<!-- Favicon -->
					...
					<div class="card bg-secondary border-0 mb-0">
						...
						<div class="card-body px-lg-5 py-lg-4">
							<div class="text-center mb-4">
								<div class="text-weight-bold">Create an Account</div>
							</div>
							<form role="form">
								<div class="form-group mb-3">
									<div class="input-group input-group-merge input-group-alternative">
										...
										<input class="form-control" placeholder="Nomor Induk" type="text">
									</div>
								</div>
								<div class="form-group mb-3">
									<div class="input-group input-group-merge input-group-alternative">
								...
								<div class="text-center">
									<button type="button" class="btn my-4" style="color: white; background-color: #1174EF">Sign Up</button>
								</div>
							</form>
							<div class="text-center">
								<small>Already have an account? </small><a href="<?php echo site_url('login'); ?>" class="text-light-info"><small>Login</small></a>
							</div>
						</div>
					</div>
				</div>
