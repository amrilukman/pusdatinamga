                    ...
                    <div class="row align-items-center py-4">
                        ...
                        <div class="col-9 text-right">
                            <ul class="nav justify-content-end">
                                ...
                                <li>
                                    <a href="<?= base_url('operator/mapel/add') ?>" class="btn btn-icon bg-white pl-3 pr-3" type="button" style="margin-left: 3pt;" data-toggle="tooltip" data-placement="top" title="Tambah data">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a class="icon icon-shape bg-gradient-red text-white rounded-circle shadow" onclick="deleteConfirm('<?php echo base_url('/operator/mapel/list') ?>')" href="#!" class="btn btn-circle btn-danger">
