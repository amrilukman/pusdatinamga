        ...
        <div class="container-fluid mt--6">
            ...
            <div class="card bg-white border-0 mb-0">
                <div class="card-header bg-transparent">
                    <div>
                        <h3 class="mb-0 text-dark">Tambah Data Wali Kelas</h3>
                    </div>
                </div>
                <div class="card-body bg-white border-0">
                    <form>
                        <div class="form-group mb-3 my-0">
                            ...
                            <input class="form-control" type="numeric" id="nisn" placeholder="Nama Wali Kelas">
                        </div>
                        <div class="form-group mb-3 my-0">
                            <label for="nama" class="form-control-label">NIP :</label>
                            <input class="form-control" type="text" id="nama" placeholder="NIP">
                        </div>
                        ...
                        <div class="row">
                            <div class="col text-right">
                                ...
                                <a onclick="addConfirm('<?php echo base_url('/operator/wali/add') ?>')" href="#!" class="btn" type="button" style="color: white; background-color: #1174EF">
                                    <span>Tambah</span>
                                </a>
                            </div>
                        </div>
