                    ...
                    <div class="row align-items-center py-4">
                        ...
                        <div class="col-9 text-right">
                            <ul class="nav justify-content-end">
                                ...
                                <li>
                                    <a href="<?= base_url('operator/wali/add') ?>" class="btn btn-icon bg-white pl-3 pr-3" type="button" style="margin-left: 3pt;" data-toggle="tooltip" data-placement="top" title="Tambah data">
                    ...
                    <table class="table align-items-center table-flush">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <a href="<?= base_url('/operator/mapel/edit') ?>" class="icon icon-shape bg-gradient-orange text-white rounded-circle shadow">
                                        <span><i class="far fa-edit"></i></span>
                                    </a>
                                    <a class="icon icon-shape bg-gradient-red text-white rounded-circle shadow" onclick="deleteConfirm('<?php echo base_url('wali/list') ?>')" href="#!" class="btn btn-circle btn-danger">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<?= base_url('/operator/wali/edit') ?>" class="icon icon-shape bg-gradient-orange text-white rounded-circle shadow">
                                        <span><i class="far fa-edit"></i></span>
                                    </a>
                                    <a class="icon icon-shape bg-gradient-red text-white rounded-circle shadow" onclick="deleteConfirm('<?php echo base_url('wali/list') ?>')" href="#!" class="btn btn-circle btn-danger">
                                        <span><i class="far fa-trash-alt"></i></span></a>
