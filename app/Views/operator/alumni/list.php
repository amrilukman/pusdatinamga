                    ...
                    <table class="table align-items-center table-flush">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <a href="<?= base_url('/operator/alumni/edit') ?>" class="icon icon-shape bg-gradient-orange text-white rounded-circle shadow">
                                        <span><i class="far fa-edit"></i></span>
                                    </a>
                                    <a class="icon icon-shape bg-gradient-red text-white rounded-circle shadow" onclick="deleteConfirm('<?php echo base_url('/operator/alumni/list') ?>')" href="#!" class="btn btn-circle btn-danger">
