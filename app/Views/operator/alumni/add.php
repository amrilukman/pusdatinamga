...
<body>
                ...
                <div class="card-body bg-white border-0">
                    <form>
                        <div class="form-group mb-3 my-0">
                            ...
                            <input class="form-control" type="numeric" id="nisn" placeholder="Nama Lengkap Alumni">
                        </div>
                        <div class="form-group mb-3 my-0">
                            <label for="nama" class="form-control-label">NISN :</label>
                            <input class="form-control" type="text" id="nama" placeholder="NISN">
                        </div>
    ...
    <?php $message = ("<?php echo base_url('/operator/alumni/list') ?>"); ?>
