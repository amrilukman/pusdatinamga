        ...
        <div class="container-fluid mt--6">
            ...
            <div class="card bg-white border-0 mb-0">
                ...
                <div class="card-body bg-white border-0">
                    ...
                    <?php endif; ?>
                    <form method="post" action="<?= base_url('operator/alumni/update/' . $alumni->nisn . '') ?>">
                        <?= csrf_field(); ?>
                        <div class="ml-3">
                            ...
                            <div class="form-group mb-3 my-0" required>
                                ...
                                <div class="custom-control custom-radio">
                                    <input type="radio" id="lakilaki" name="jenis_kelamin" class="custom-control-input" value="L" <?= ($alumni->jenis_kelamin == "L" ? "checked" : ""); ?>>
                                    <label class="custom-control-label" for="lakilaki">Laki-laki</label>
                                </div>
                                <div class="custom-control custom-radio">
                                    <input type="radio" id="perempuan" name="jenis_kelamin" class="custom-control-input" value="P" <?= ($alumni->jenis_kelamin == "P" ? "checked" : ""); ?>>
                                ...
                                <div class="form-group col-4">
                                    ...
                                    <select class="form-control" id="tahun_lulus" name="tahun_lulus">
                                        ...
                                        <?php foreach (range(2004, date('Y')) as $tahun) { ?>
                                            <option value="<?= $tahun; ?>" <?= ($alumni->tahun_lulus == $tahun ? "selected" : ""); ?>><?= $tahun ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="form-group col-4">
                                    ...
                                    <select class="form-control" name="jurusan" id="jurusan" onchange="showhideForm(this.value);" required>
                                        ...
                                        <?php foreach ($jurusan as $key => $data) { ?>
                                            <option value="<?= $data->id_jurusan; ?>" <?= ($alumni->jurusan == $data->id_jurusan ? "selected" : ""); ?>><?= $data->nama_jurusan; ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                                <div class="col-4">
                                    ...
                                    <select class="form-control" name="rombel" id="rombel" required disabled>
                                        ...
                                        <option id="rombel1" value="1" <?= ($alumni->rombel == "1" ? "selected" : ""); ?>>1</option>
                                        <option id="rombel2" value="2" <?= ($alumni->rombel == "2" ? "selected" : ""); ?>>2</option>
                                        <option id="rombel3" value="3" <?= ($alumni->rombel == "3" ? "selected" : ""); ?>>3</option>
                                        <option id="rombel4" value="4" <?= ($alumni->rombel == "4" ? "selected" : ""); ?>>4</option>
                                    </select>
                                </div>
                                <script>
