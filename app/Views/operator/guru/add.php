                        ...
                        <div class="ml-3">
                            <div class="form-row my-0">
                                ...
                                <div class="form-group col-4 mb-0">
                                    ...
                                    <input class="form-control" type="text" id="sk_cpns" name="sk_cpns" placeholder="SK-CPNS" value="<?= old('sk_cpns'); ?>" disabled>
                                </div>
                                <div class="form-group col-4">
                            ...
                            <div class="form-row my-0 mb-3">
                                <div class="form-group col-4">
                                    <label for="jurusan" class="form-control-label">Jurusan yang Diampu : <span class="text-danger">*</span></label>
