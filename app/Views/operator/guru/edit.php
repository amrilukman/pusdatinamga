                ...
                <div class="card-body bg-white border-0">
                    <form>
                        <div class="form-group mb-3 my-0">
                            ...
                            <input class="form-control" type="numeric" id="nisn" value="12345678901011">
                        </div>
                        <div class="form-group mb-3 my-0">
                            <label for="nama" class="form-control-label">Nama :</label>
                            <input class="form-control" type="text" id="nama" value="Rohman Pujadi M.Kom">
                        </div>
                        <div class="form-group mb-3 my-0">
                            <label for="jeniskelamin" class="form-control-label">Jenis Kelamin :</label>
                            <div class="custom-control custom-radio">
                                <input type="radio" id="jeniskelamin" name="lakilaki" class="custom-control-input" checked>
                        ...
                        <div class="form-group form-row mb-3 my-0">
                            <div class="col-4">
                                ...
                                <input class="form-control" type="text" id="tempatlahir" value="Pemalang">
                            </div>
                            <div class="col-8">
                                <label for="tanggallahir" class="form-control-label">Tanggal Lahir</label>
                                <input class="form-control" type="date" id="tanggallahir" value="1990-09-20">
                            </div>
                        </div>
                        <div class="form-group form-row mb-3 my-0">
                            <div class="col-4">
                            ...
                            <div class="col-4">
                                ...
                                <div class="form-group mb-3 my-0">
                                    ...
                                    <select class="form-control" id="kelas">
                                        ...
                                        <option selected>Jaringan Komputer</option>
                                        <option>XII</option>
                                    </select>
                                </div>
                                <div class="form-group mb-3 my-0">
                        ...
                        <div class="row">
                            <div class="col text-right">
                                ...
                                <a onclick="editConfirm('<?php echo base_url('/operator/guru/edit') ?>')" href="#!" class="btn" type="button" style="color: white; background-color: #1174EF">
                                    <span>Edit</span>
                                </a>
                            </div>
                        </div>
