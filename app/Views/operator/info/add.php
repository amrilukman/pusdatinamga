                ...
                <div class="col-lg-5">
                    <div class="card bg-white border-0">
                        <div class="card-header bg-transparent pb-3">
                            <div class="row">
                                ...
                                <div class="col-8 justify-content-center text-muted text-center mt-1">
                                    <h3>Tambah Informasi & Pengumuman</h3>
                                </div>
                            </div>
                        </div>
                        <div class="card-body px-lg-4 py-lg-4 mb-3">
                            ...
                            <form method="post" action="<?= base_url('operator/info/store') ?>" role="form">
                                <?php csrf_field(); ?>
                                <div class="form-group mb-3">
                                    <label for="judul_info" class="form-control-label">Judul Informasi :</label>
                                    <input class="form-control" id="judul_info" name="judul_info" value="<?= old('judul_info') ?>" type="text" placeholder="Judul Informasi" required>
                                </div>
                                <div class="form-group mb-3">
                                    <label class="form-control-label" for="deskripsi">Deskripsi</label>
                                    <textarea class="form-control" id="deskripsi" name="deskripsi" rows="3" placeholder="Deskripsi" value="<?= old('deskripsi') ?>" required></textarea>
                                </div>
                                <div class="form-group mb-3 my-0">
                                    <label for="link_info" class="form-control-label">Link :</label>
                                    <input type="text" class="form-control" name="link_info" value="<?= old('link_info') ?>" required onblur="checkURL(this)">
                                </div>
                                <script>
