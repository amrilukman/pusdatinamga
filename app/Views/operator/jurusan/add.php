                ...
                <div class="header-body">
                    <div class="row align-items-center py-4">
                        ...
                        <div class="col text-right">
                            <h6 class="h2 text-white d-inline-block mb-0">Form Data Jurusan</h6>
                        </div>
                    </div>
                    <!-- ============================================================== -->
                    <!-- Rangkuman data -->
        ...
        <div class="container-fluid mt--6">
            ...
            <div class="card bg-white border-0 mb-0">
                <div class="card-header bg-transparent">
                    <div>
                        <h3 class="mb-0 text-dark">Tambah Data Jurusan</h3>
                    </div>
                </div>
                <div class="card-body bg-white border-0">
                    <form>
                        <div class="form-group mb-3 my-0">
                            <label for="nisn" class="form-control-label">ID Jurusan :</label>
                            <input class="form-control" type="numeric" id="nisn" placeholder="ID">
                        </div>
                        <div class="form-group mb-3 my-0">
                            <label for="nama" class="form-control-label">Nama Jurusan :</label>
                            <input class="form-control" type="text" id="nama" placeholder="Nama Jurusan">
                        </div>
                        <div class="form-group mb-3 my-0">
                            <label for="jeniskelamin" class="form-control-label">Jumlah Rombel :</label>
                            <input class="form-control" type="number" id="jumlahrombel" Placeholder="Jumlah Rombongan Belajar per Kelas">
                        </div>
                        <div class="row">
                            <div class="col text-right">
                                <input class="btn btn-warning mr-2" type="reset" value="Reset">
                                <a onclick="addConfirm('<?php echo base_url('/operator/alumni/add') ?>')" href="#!" class="btn" type="button" style="color: white; background-color: #1174EF">
                                    <span>Tambah</span>
                                </a>
                            </div>
                        </div>
