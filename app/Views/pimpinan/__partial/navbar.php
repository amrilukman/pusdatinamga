...
<nav class="navbar navbar-top navbar-expand navbar-dark bg-gradient-info border-bottom">
    <div class="container-fluid">
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <?php if (session()->get('password') == md5('12345678') and current_url() == base_url('pimpinan/dashboard')) : ?>
                <div class="alert alert-danger inline alert-dismissible fade show mb-0 mt-0" role="alert">
                    ...
                    <a href="<?= base_url('pimpinan/profil/resetpassword') ?>" class="btn btn-icon btn-secondary btn-sm ml-4 mr-0" type="button">
            ...
            <ul class="navbar-nav align-items-center  ml-auto ml-md-0 ">
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu  dropdown-menu-right ">
                        ...
                        <a href="<?= base_url('pimpinan/profil') ?>" class="dropdown-item">
